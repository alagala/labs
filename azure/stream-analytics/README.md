...
1. Your favourite IDE to connect to the Azure SQL Data Warehouse (eg. [Azure Data Studio](https://docs.microsoft.com/en-us/sql/azure-data-studio/) or [SQL Server Management Studio](https://docs.microsoft.com/en-us/sql/ssms/sql-server-management-studio-ssms))
...
- **sql_server_login** and **sql_server_password**
...
## Configure the SQL Data Warehouse output
